...
<ul>
  ...
  <li>Fixed splitter border lines and tab-screen corner issue in split view <a href="https://github.com/mozilla-firefox/firefox/commit/b0c06ce109fb">[D292101]</a></li>
</ul>
...
<div>
  <a href="#" target="_blank">
    <img src="https://skillicons.dev/icons?i=js,ts,react,nodejs,expressjs,nextjs,py,flask,fastapi,django,opencv,sklearn,pytorch,tensorflow,c,cpp,rust,matlab,mysql,mongodb,aws,git,docker,kubernetes,bash,linux,arduino,raspberrypi&perline=14&theme=dark"/>
  </a>
</div>
